...
class RegisterProducts extends StatelessWidget {
  ...
  SizedBox containerTextForm(BuildContext context, String title, String description) {
    return SizedBox(
            ...
            children: [const SizedBox(height: 8,),
              Text(title, style: const TextStyle(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(border: Border.all(color: bottomNavBarStroke, ),
    ...
    return Container(
          ...
          child: Column(
            children: [Container(
              ...
              ),child: const Icon(Ionicons.camera_outline, size: 64,  color: Color(0xff241E20),),
            ),],
          ),
        );
  }
